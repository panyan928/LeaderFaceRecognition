...
class Config:
    ...
    def BaseFeat(self, leader):
        ...
        for path in bases:
            ...
            for i in  range(2,10):#[0] + list(range(20, 102, 2)):
                # i = i * 0.1
                if i==0 :
                    pad = [0, 0]
                else:
...
if __name__ == '__main__':
    ...
    output = open('result_dlib_DXP.txt', 'w')
        ...
        for label in open(label_file_path):
            ...
            for i, d in enumerate(dets):
                ...
                for threshold in range(100, 150, 5):
                    ...
                    if FP[threshold]+FN[threshold]+right[threshold][0]+right[threshold][1]+no_label != countDet:
                    	print('error!')
    ...
    # print('recall:{}'.format(right[0]/countData[0]))
