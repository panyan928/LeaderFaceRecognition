...
class FaceAlignment:
    ...
    def __init__(self, landmarks_type, network_size=NetworkSize.LARGE,
        ...
        fan_path = '/home/disk3/py/face-alignment/examples/data/' + network_name
        print(fan_path)
        ...
        if landmarks_type == LandmarksType._3D:
            ...
            depth_model_path = '/home/disk3/py/face-alignment/examples/data/'+network_name
    ...
    def detect_faces(self, image):
        ...
        """
        return self.face_detector(image, 3)

    def get_landmarks(self, input_image, bbox, all_faces=False):
        with torch.no_grad():
            ...
            if len(image.shape) != 3 or image.shape[2] !=3 :
                ...
                cv2.imwrite(input_image, img_cv)
                image = io.imread(input_image)
            ...
            if faces_num == 1:
                ...
                center = torch.FloatTensor(
                    [d_right - (d_right - d_left) / 2.0, d_bottom -
                     (d_bottom - d_top) / 2.0])
                center[1] = center[1] - (d_bottom - d_top) * 0.12
                scale = (d_right - d_left +
                         d_bottom - d_top) / 195.0
