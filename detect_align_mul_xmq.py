...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        ...
        #xmq
        FP_box = dict()
        output = open('result_txt/result_align_mul_1_xmq.txt', 'w')
            ...
            for leader in ['DXP']:
                ...
                for label in open(label_file_path):
                    ...
                    for d in bbox:
                        ...
                        #xmq
                        c = model.get_fp_by_landmark(img_cv, bound1, preds)
                        ...
                        for feat_leader in FP_box:
                            for f2 in FP_box[feat_leader]:


                                dist = np.sum(np.square(f - f2[0]))
                                print("dist:")
                                print(dist)
                                #xmq
