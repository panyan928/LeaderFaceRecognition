...
if __name__ == '__main__':
    ...
    output = open('result_txt/result_MTCNN_sin_2.txt', 'w')
        ...
        for label in open(label_file_path):
            ...
            for d, point in zip(boxes,points):
                ...
                if iou < 0.5:
                    ...
                    cv2.putText(img_cv, 'no label', (bound1[0], bound1[1]), 0, 1, (255, 0, 0))
                ...
                if result == positive: 
                    ...
                    cv2.putText(img_cv, result  + ' ' + positive, (bound1[0], bound1[1]), 0, 0.5, (0, 255, 0))
                    cv2.imwrite(save_root + 'falsePositive/' + img_name + '.jpg', img_cv)
                    FP += 1
                else: # result != 'OTHERS': 
                    FN += 1
                    cv2.putText(img_cv, result  + ' ' + positive, (bound1[0], bound1[1]), 0, 0.5, (0, 0, 255))
